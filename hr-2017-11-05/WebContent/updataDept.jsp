...
<html>
	...
	<body>
		<div class="container">	
			...
			<form id="form1" method="post" class="form-horizontal " action="UpdataDeptServlet">
				<div class="form-group">
					<label for="" class="col-md-2">部门名称</label>
					<div class="col-md-10">
						<input type="text" id="deptName" name="deptName"  class="form-control" value="${dept.deptName }"/>
					</div>					
				</div>	
				<div class="form-group">
					<label for="" class="col-md-2">部门地址</label>
					<div class="col-md-10">
						<input type="text" id="deptLoc" name="deptLoc" class="form-control" value="${dept.deptLoc }"/>
					</div>					
				</div>
				...
				<div class="form-group">					
					<div class="col-md-10 col-md-offset-2">
						...
						<input type="submit"  value="修改表单" class="btn btn-success"/>
